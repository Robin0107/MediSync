...
public class listado_salas extends javax.swing.JFrame {
...
new menu_ajustes().setVisible(true);
  ...
  cargar_sala();
    ...
    internos.sala.setText((String)table_model.getValueAt(tabla_salas.getSelectedRow(), 1));
    internos.IDSALAS.setText((String)table_model.getValueAt(tabla_salas.getSelectedRow(), 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listado_salas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
