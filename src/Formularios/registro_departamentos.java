...
public class registro_departamentos extends javax.swing.JFrame {
    ...
    void cargar_departamentos(){
        try{
            String query = "SELECT * FROM departamentos WHERE (id_departamentos LIKE '%" + buscar.getText() + "%' OR nombre LIKE '%"+buscar.getText()+"%') and estado = 1";
            Statement st = cn.createStatement();
            ResultSet rs = st.executeQuery(query);
            DefaultTableModel model_table = (DefaultTableModel)tabla_departamentos.getModel();
            model_table.getDataVector().clear();
            String registros[] = new String[5];
            while(rs.next()){
                registros[0] = rs.getString("id_departamentos");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ID DEPARTAMENTOS");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(12, 93, 172));
        jLabel2.setText("DEPARTAMENTO");

        tabla_departamentos.setBackground(new java.awt.Color(12, 93, 172));
        tabla_departamentos.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tabla_departamentos.setSelectionBackground(new java.awt.Color(102, 255, 51));
        ...
        if (tabla_departamentos.getColumnModel().getColumnCount() > 0) {
            tabla_departamentos.getColumnModel().getColumn(1).setMinWidth(200);
            tabla_departamentos.getColumnModel().getColumn(1).setMaxWidth(200);
            tabla_departamentos.getColumnModel().getColumn(2).setMinWidth(250);
            tabla_departamentos.getColumnModel().getColumn(2).setMaxWidth(250);
        }
        ...
        jLabel4.setText("REGISTRO DE DEPARTAMENTOS");
...
new menu_ajustes().setVisible(true);
    ...
    private void agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarActionPerformed
         if(nombre.getText().equals("")){
            ...
            try{
                String query = "INSERT INTO departamentos(nombre,descripcion) VALUES ('" + nombre.getText() + "','" + descripcion.getText() + "')";
                PreparedStatement psz = cn.prepareStatement(query);
                psz.executeUpdate();
                JOptionPane.showMessageDialog(null, "Departamentos agregado");
                limpiar_campos();
                cargar_departamentos();
            } catch(Exception error){
                JOptionPane.showMessageDialog(null, "Error: " + error);
  ...
  cargar_departamentos();
    ...
    private void actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actualizarActionPerformed
           if(nombre.getText().equals("") || idtipo.getText().equals("")){
            ...
            String query = "UPDATE departamentos SET descripcion = '" + descripcion.getText() +"', nombre = '" + nombre.getText() +"' WHERE id_departamentos = '" + idtipo.getText() + "'";
            try{
                PreparedStatement psz = cn.prepareStatement(query);
                psz.executeUpdate();
                JOptionPane.showMessageDialog(null, "Departamentos modificado");
                limpiar_campos();
                cargar_departamentos();
            } catch(Exception error){
                JOptionPane.showMessageDialog(null, "Error: " + error);
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
            ...
            String query = "UPDATE departamentos SET estado = 0 WHERE id_departamentos = '" + idtipo.getText() + "'";
            try{
                PreparedStatement psz = cn.prepareStatement(query);
                psz.executeUpdate();
                JOptionPane.showMessageDialog(null, "Departamentos eliminado");
                limpiar_campos();
                cargar_departamentos();
            } catch(Exception error){
                JOptionPane.showMessageDialog(null, "Error: " + error);
    ...
    DefaultTableModel table_model = (DefaultTableModel)tabla_departamentos.getModel();
    idtipo.setText((String) table_model.getValueAt(tabla_departamentos.getSelectedRow(), 0));
    nombre.setText((String) table_model.getValueAt(tabla_departamentos.getSelectedRow(), 1));
    descripcion.setText((String) table_model.getValueAt(tabla_departamentos.getSelectedRow(), 2));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registro_departamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
